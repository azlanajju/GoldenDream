...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $promoterId = !empty($_POST['promoter_id']) ? $_POST['promoter_id'] : null;
        $status = $_POST['status'];
                ...
                <div class="form-card-body">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="promoter_id" name="promoter_id">
                                <option value="">None (Direct Customer)</option>
                                <?php foreach ($promoters as $promoter): ?>
                                    <option value="<?php echo $promoter['PromoterID']; ?>" <?php echo $customer['PromoterID'] == $promoter['PromoterID'] ? 'selected' : ''; ?>>
