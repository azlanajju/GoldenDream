...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] === 'XMLHttpRequest') {
  ...
  try {
    ...
    $check_query = "SELECT CustomerID FROM Customers WHERE Email = :email";
    ...
    $contact = date('YmdHis') . rand(1000, 9999);
    ...
    // Insert new customer
    $query = "INSERT INTO Customers (CustomerUniqueID, Name, Contact, Email, PasswordHash, Status) 
              VALUES (:unique_id, :name, :contact, :email, :password, 'Active')";
